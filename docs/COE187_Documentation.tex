...
Fig. \ref{fig:result1} and Fig. \ref{fig:result2} show the terminal output during real-time classification, displaying the inference results with confidence scores.

\begin{figure}[htbp]
\centerline{\includegraphics[width=\columnwidth]{result1.png}}
\caption{Classification result showing real-time inference output.}
\label{fig:result1}
\end{figure}

\begin{figure}[htbp]
\centerline{\includegraphics[width=\columnwidth]{result2.png}}
\caption{Additional classification result demonstrating system performance.}
\label{fig:result2}
\end{figure}
