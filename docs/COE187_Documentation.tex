...
The system was tested with both human and horse subjects to validate the classification accuracy. Fig. \ref{fig:result1} shows the terminal output when a human is detected, while Fig. \ref{fig:result2} demonstrates horse classification. Both results display the class prediction with confidence scores in real-time.

\begin{figure}[htbp]
\centerline{\includegraphics[width=\columnwidth]{result1.png}}
\caption{Terminal output showing human classification result with confidence score.}
\label{fig:result1}
\end{figure}

\begin{figure}[htbp]
\centerline{\includegraphics[width=\columnwidth]{result2.png}}
\caption{Terminal output showing horse classification result with confidence score.}
\label{fig:result2}
\end{figure}
...
The complete source code for this project is available on GitHub at: \url{https://github.com/Seuketchi/max78000-horse-human-classifier}
